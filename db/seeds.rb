...
Country.create!(
	...
	{continent_id: '1',name: 'インド',money:'ルピー',world_heritage: 'ニューデリー',language: 'ヒンディー語',photo: open("#{Rails.root}/db/fixtures/103.png")},
	{continent_id: '1',name: 'タイ',money:'バーツ',world_heritage: 'バンコク',language: 'タイ語',photo: open("#{Rails.root}/db/fixtures/104.png")},
